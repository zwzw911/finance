...
var hash = function hash(string, hashType) {
    if ('undefined' === typeof string || string.length > 255) {
        return false;
    }
...
//hash+crypt
var hmac = function hmac(hashType, string, pemFilePath) {
    if ('undefined' === typeof string || string.length > 255) {
        return false;
    }
...
var crypt = function crypt(cryptType, string, pemFilePath) {
    if ('undefined' === typeof string || string.length > 255) {
        return false;
    }
...
var decrypt = function decrypt(cryptType, string, pemFilePath) {
...
//产生[0-9a-f]的随机字符
var asyncGenSalt = function asyncGenSalt(saltLength, cb) {
...
//# sourceMappingURL=crypt-compiled.js.map