...
var inputRule = {
    ...
    employee: {
        ...
        department: {
            chineseName: '所属部门',
            type: inputDataType.string,
            require: { define: true, error: { rc: 10026 }, mongoError: { rc: 20026, msg: '所属部门不能为空' } },
            format: { define: regex.objectId, error: { rc: 10028 }, mongoError: { rc: 20028, msg: '所属部门的id格式不正确' } } },
        onBoardDate: {},
        cDate: {
            chineseName: '创建日期',
            type: inputDataType.date,
            require: { define: true, error: { rc: 10030 }, mongoError: { rc: 20030, msg: '创建日期不能为空' } }
        },
        uDate: {
            chineseName: '修改日期',
            type: inputDataType.date,
            require: { define: true, error: { rc: 10032 }, mongoError: { rc: 20032, msg: '修改日期不能为空' } }
        },
        dDate: {
            chineseName: '删除日期',
            type: inputDataType.date,
            require: { define: false, error: { rc: 10034 }, mongoError: { rc: 20054, msg: '删除日期不能为空' } }
        }
    },
    billType: {
        name: {
            chineseName: '单据类别',
            type: inputDataType.string,
            require: { define: true, error: { rc: 10040 }, mongoError: { rc: 20040, msg: '单据类别不能为空' } },
