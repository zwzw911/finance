...
/*        notExist:{rc:68004,msg:{client:'验证码不存在',server:'验证码不存在'}},
    ...
    validateFunc:{
        ...
        validateInputSearchFormat:{
            ...
            inputSearchFKFiledValueCanNotEmpty:{rc:69507,msg:{client:`查询参数格式不正确`,server:`查询参数的外键字段不能为空`}},
            inputSearchFKFiledValueNotObject:{rc:69506,msg:{client:`查询参数格式不正确`,server:`查询参数的外键字段值必须是对象不能为空`}},
            ...
            inputSearchValueElementKeysLengthExceed:{rc:69511,msg:{client:`查询字符不正确`,server:`查询参数的键值中的查询元素的键数量超出`}},
            ...
            inputSearchFKNoRelatedRule:{rc:69515,msg:{client:`查询字符不正确`,server:`查询参数的外键无对应的rule`}},
            ...
            inputSearchValueElementNeedKeyValue:{rc:69520,msg:{client:`查询字符格式不正确`,server:`查询参数中，字段类型为数字或者日期，必须包含value`}},
            inputSearchValueElementCompOpWrong:{rc:69522,msg:{client:`查询字符格式不正确`,server:`查询参数中，操作符不是预定义的符号之一`}},
