...
var getBasicInfo = function getBasicInfo(userId, callback) {
...
var saveBasicInfo = function saveBasicInfo(userId, userName, mobilePhone, callback) {
    userModel.findById(userId, function (err, findedUser) {
        if (err) {
            errorRecorder({ rc: err.code, msg: err.errmsg }, 'getBasicInfo', 'findById');
            return callback(err, runtimeDbError.user.findById);
...
var savePasswordInfo = function savePasswordInfo(userId, oldPassword, newPassword, callback) {
...
//# sourceMappingURL=personalInfo-compiled.js.map