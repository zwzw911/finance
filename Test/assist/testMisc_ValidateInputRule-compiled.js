...
var checkAllMandatoryFieldsExist = function checkAllMandatoryFieldsExist(test) {
    ...
    var func = testModule.va.checkSingleFieldRuleDefine;
    var coll = 'testColl';
    var field = 'testField';
    var rule = {};
...
var checkChineseNameRule = function checkChineseNameRule(test) {
    var func = testModule.validateInputRule.checkSingleFieldRuleDefine;
    var coll = 'testColl';
    var field = 'testField';
    var rule = {};
...
var checkTypeValidate = function checkTypeValidate(test) {
    var func = testModule.validateInputRule.checkSingleFieldRuleDefine;
    var coll = 'testColl';
    var field = 'testField';
    var rule = {};
...
var checkRuleFormat = function checkRuleFormat(test) {
    var func = testModule.validateInputRule.checkSingleFieldRuleDefine;
    var coll = 'testColl';
    var field = 'testField';
    var rule = {};
...
//7 check default
var checkDefaultType = function checkDefaultType(test) {
    var func = testModule.validateInputRule.checkSingleFieldRuleDefine;
    var coll = 'testColl';
    var field = 'testField';
    var rule = {};
...
exports.validate = {
    ...
    checkChineseNameRule: checkChineseNameRule,
    checkTypeValidate: checkTypeValidate,
    checkRelatedField: checkRelatedField,
    checkRuleFormat: checkRuleFormat,
    checkRuleDefine: checkRuleDefine,
    checkDefaultType: checkDefaultType

};

//# sourceMappingURL=testMisc_ValidateInputRule-compiled.js.map