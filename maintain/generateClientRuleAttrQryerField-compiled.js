...
//value
//type
var extractQueryFieldFromInputAttr = function extractQueryFieldFromInputAttr(inputAttr, inputRule) {
    var result = {};
    for (var coll in inputAttr) {
        result[coll] = [];
        for (var field in inputAttr[coll]) {
            var tmpResult = {};
...
//# sourceMappingURL=generateClientRuleAttrQryerField-compiled.js.map